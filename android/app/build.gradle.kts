...
android {
    ...
    defaultConfig {
        ...
        applicationId = "io.github.bananguh.ErmChat"
    ...
    buildTypes {
        release {
            ...
            // R8 strips unused JVM-side code (embedding + plugins); smaller
            // DEX means less class loading/verification during cold start.
